...
# image_shape = (76,90,56,1)
# image_shape = (51,71,56,1)
...
def test_model_for_lr_images(input_low_res, input_high_res, model, number_of_images, output_dir):
    x_test_lr = Utils.load_test_data(input_low_res, '.npy', number_of_images)
    x_test_hr = Utils.load_test_refdata(input_high_res, '.npy', number_of_images)
    Utils.plot_test_generated_images(output_dir, model, x_test_lr, x_test_hr)
...
if __name__ == "__main__":
    ...
    if values.test_type == 'test_model':
        ...
        test_model_for_lr_images(values.input_low_res, values.input_hig_res, model, values.number_of_images, values.output_dir)
